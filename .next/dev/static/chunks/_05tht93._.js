...
"[project]/data/winners.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/image.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$BackgroundGlow$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/BackgroundGlow.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$winners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/winners.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Winners() {
    ...
    if ($[0] !== "5d33a323006c3ce568cf2062f02d5f5ce8c1c27169d44d0f34145e66a4d6cdf1") {
        for(let $i = 0; $i < 32; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5d33a323006c3ce568cf2062f02d5f5ce8c1c27169d44d0f34145e66a4d6cdf1";
    }
    const [activeYearIndex, setActiveYearIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const activeYearData = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$winners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["winners"][activeYearIndex];
    const activeTheme = themeMap[activeYearData.theme] || themeMap.emerald;
    let t0;
    if ($[1] !== activeYearData.theme) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$BackgroundGlow$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        $[1] = activeYearData.theme;
        $[2] = t0;
    } else {
        t0 = $[2];
    }
    const t1 = `mb-3 text-sm font-semibold uppercase tracking-[0.4em] transition-colors duration-500 ${activeTheme.text}`;
    let t2;
    if ($[3] !== t1) {
    ...
    let t6;
    if ($[9] !== activeYearIndex) {
        t6 = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$winners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["winners"].map({
            "Winners[winners.map()]": (yearGroup, index)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "Winners[winners.map() > <button>.onClick]": ()=>setActiveYearIndex(index)
                    }["Winners[winners.map() > <button>.onClick]"],
    ...
    const t8 = activeYearData.year;
    let t9;
    if ($[13] !== activeTheme.badge || $[14] !== activeTheme.text || $[15] !== activeYearData.projects) {
        let t10;
        if ($[17] !== activeTheme.badge || $[18] !== activeTheme.text) {
            t10 = ({
                "Winners[activeYearData.projects.map()]": (project)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: project.team.map(_WinnersActiveYearDataProjectsMapProjectTeamMap)
                                            }, void 0, false, {
                                                fileName: "[project]/components/sections/Winners.tsx",
                                                lineNumber: 116,
                                                columnNumber: 1245
            ...
            })["Winners[activeYearData.projects.map()]"];
            $[17] = activeTheme.badge;
            $[18] = activeTheme.text;
            $[19] = t10;
        } else {
            t10 = $[19];
        }
        t9 = activeYearData.projects.map(t10);
        $[13] = activeTheme.badge;
        $[14] = activeTheme.text;
        $[15] = activeYearData.projects;
        $[16] = t9;
    } else {
        t9 = $[16];
    }
    ...
    let t11;
    if ($[22] !== activeYearData.year || $[23] !== t10) {
...
_s(Winners, "lRvfQFG3GDdgqoBOZYb5168VN2M=");
_c = Winners;
function _WinnersActiveYearDataProjectsMapProjectTeamMap(member) {
...
//# sourceMappingURL=_05tht93._.js.map